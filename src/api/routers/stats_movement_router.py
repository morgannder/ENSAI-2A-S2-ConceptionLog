...
stats_movement_service = StatMovementService()
...
def get_player_average_statistics(platform_id: str):
    ...
    stats = stats_movement_service.get_player_average_movement_stats(player)
...
def get_player_match_statistics(
    ...
    stats = stats_movement_service.get_player_match_movement_stats(player, match)
