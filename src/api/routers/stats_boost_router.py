...
def get_rank_statistics(
    ...
    try:
        ...
        stats_dto = stats_boost_service.get_average_stats_boost_by_rank(rank, game_mode)
...
def get_player_average_statistics(
    ...
    try:
        ...
        # Service retourne directement StatsBoostAggregatedDTO
        stats_dto = stats_boost_service.get_player_average_boost_stats(
            player, game_mode
        )
...
def get_player_match_statistics(
    ...
    try:
        ...
        stats_bo = stats_boost_service.get_player_match_boost_stats(
