...
export const RANKS = [
  ...
  { name: "Silver I",          fullName: "Silver I",          color: "#8b8b8d", glow: "#a8a9ad55", icon: "🥈", image: "/images/ranks/argent_1.png"        },
  { name: "Silver II",         fullName: "Silver II",         color: "#8b8b8d", glow: "#a8a9ad55", icon: "🥈", image: "/images/ranks/argent_2.png"        },
  { name: "Silver III",        fullName: "Silver III",        color: "#8b8b8d", glow: "#a8a9ad55", icon: "🥈", image: "/images/ranks/argent_3.png"        },
  ...
  { name: "Diamond I",         fullName: "Diamond I",         color: "#4346de", glow: "#6a9de055", icon: "💎", image: "/images/ranks/diamant_1.png"       },
  { name: "Diamond II",        fullName: "Diamond II",        color: "#4346de", glow: "#6a9de055", icon: "💎", image: "/images/ranks/diamant_2.png"       },
  { name: "Diamond III",       fullName: "Diamond III",       color: "#4346de", glow: "#6a9de055", icon: "💎", image: "/images/ranks/diamant_3.png"       },
  ...
  { name: "Grand Champion I",  fullName: "Grand Champion I",  color: "#e05a5a", glow: "#00ddff55", icon: "⭐", image: "/images/ranks/grand_champion_1.png" },
  { name: "Grand Champion II", fullName: "Grand Champion II", color: "#e05a5a", glow: "#00ddff55", icon: "⭐", image: "/images/ranks/grand_champion_2.png" },
  { name: "Grand Champion III",fullName: "Grand Champion III",color: "#e05a5a", glow: "#00ddff55", icon: "⭐", image: "/images/ranks/grand_champion_3.png" },
  { name: "Supersonic Legend", fullName: "Supersonic Legend", color: "#f6eded", glow: "#ff00ff55", icon: "🚀", image: "/images/ranks/ssl.png"             },
...
export const PLATFORMS = [
  ...
  { id: "ps4",    label: "PlayStation", icon: "▲", logo: "/images/platforms/psn.png"    },
...
const PLATFORM_MAPPING = {
  ...
  "psn": "ps4", "PlayStation": "ps4", "PSN": "ps4",
  "ps4": "ps4", "PS4": "ps4", "playstation": "ps4",
...
// ── Stats Core ────────────────────────────────────────────────────────────────
// Returns null (no error) when the backend has no data for this player/mode (404/422)
export async function getPlayerCoreStats(platformId, gameMode = null) {
  ...
  // No data for this player/mode — treat as empty, not an error
